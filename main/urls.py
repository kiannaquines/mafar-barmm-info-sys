...
urlpatterns = [
    ...
    path(
        "mafar/beneficiary/personal/edit/<int:pk>",
        UpdatePersonalInfoView.as_view(),
        name="update_beneficiary_personal_info",
    ),
    path(
        "mafar/beneficiary/farm/edit/<int:pk>",
        UpdateFarmInfoView.as_view(),
        name="update_beneficiary_farm_info",
    ),
    path(
        "mafar/beneficiary/delete/<int:pk>",
        DeleteBeneficaryView.as_view(),
        name="remove_beneficiary_farm_info",
    ),
    # Notification
    path("mafar/notification", NotificationView.as_view(), name="notification"),
    path(
        "mafar/notification/add", AddNotificationView.as_view(), name="add_notification"
    ),
    path(
        "mafar/notification/update/<int:pk>",
        UpdateNotoficationInfoView.as_view(),
        name="update_notification",
    ),
    path(
        "mafar/notification/delete/<int:pk>",
        DeleteNotificationInfoView.as_view(),
        name="delete_notification",
    ),
    # Approve and Notify
    path(
        "mafar/approve_and_notify",
        ApproveAndNotifyView.as_view(),
        name="approve_and_notify",
    ),
    # Report
    ...
    path(
        "mafar/municipality/add", AddMunicipalityView.as_view(), name="add_municipality"
    ),
    path(
        "mafar/barangay/update/<int:pk>",
        UpdateBarangayView.as_view(),
        name="update_barangay",
    ),
    path(
        "mafar/municipality/update/<int:pk>",
        UpdateMunicipalityView.as_view(),
        name="update_municipality",
    ),
    path(
        "mafar/barangay/delete/<int:pk>",
        DeleteBarangayView.as_view(),
        name="delete_barangay",
    ),
    path(
        "mafar/municipality/delete/<int:pk>",
        DeleteMunicipalityView.as_view(),
        name="delete_municipality",
    ),
]
