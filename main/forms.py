...
class FilterOverAllBeneficiary(forms.Form):
    ...
    activity = forms.ChoiceField(
        ...
        widget=forms.Select(
            attrs={"class": "form-select", "placeholder": "Select activity"}
        ),
    )
    ...
    livelihood = forms.ChoiceField(
        ...
        widget=forms.Select(
            attrs={"class": "form-select", "placeholder": "Select livelihood"}
        ),
    )
...
class ExportReportForm(forms.Form):
    ...
    farmer_activity = forms.ChoiceField(
        ...
        choices=Notification.FARMER_ACTIVITY,
        widget=forms.Select(
            attrs={"class": "form-control", "placeholder": "Select activity"}
        ),
    )
